            ...
            <footer className="footer">
                <div className="footer-content">
                    ...
                    <div className="footer-social">
                        <a href="src/components#" className="social-icon"><img src="https://img.icons8.com/ios/50/000000/facebook.png" alt="Facebook" /></a>
                        <a href="src/components#" className="social-icon"><img src="https://img.icons8.com/ios/50/000000/twitter.png" alt="Twitter" /></a>
                        <a href="src/components#" className="social-icon"><img src="https://img.icons8.com/ios/50/000000/linkedin.png" alt="LinkedIn" /></a>
                        <a href="src/components#" className="social-icon"><img src="https://img.icons8.com/ios/50/000000/instagram.png" alt="Instagram" /></a>
                    </div>
